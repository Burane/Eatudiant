...
public class CookwareAdapter extends BaseAdapter {

    private Context context; //context
    @Getter
    private ArrayList<Requirement> items; //data source of the list adapter

    public CookwareAdapter(Context context, ArrayList<Requirement> items) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).
                    inflate(R.layout.item_cookware, parent, false);
    ...
    static final class ViewHolder {
        ...
        @BindView(R.id.cookwareName)
        TextView cookwareName;

        @BindView(R.id.cookwareQty)
        TextView cookwareQty;
